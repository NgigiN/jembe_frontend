...
///
/// ### FK note (P3 scope)
/// `animalTypeId` is passed through as-is — see the `// TODO(P4)` note in
/// `herd_model.dart`. This repository supports create/update only for a
/// herd whose parent animal type is already synced (has a server id);
