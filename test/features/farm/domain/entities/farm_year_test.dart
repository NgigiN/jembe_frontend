...
void main() {
  group('FarmYear', () {
    test('January start month behaves like a plain calendar year', () {
      ...
      expect(fy.start, DateTime(2026, 1, 1));
      expect(fy.end, DateTime(2027, 1, 1));
    ...
    test('a July start month before July falls in the previous fiscal year', () {
      ...
      expect(fy.start, DateTime(2025, 7, 1));
      expect(fy.end, DateTime(2026, 7, 1));
    ...
    test('a July start month on/after July falls in that calendar year', () {
      final fy = FarmYear.containing(DateTime(2026, 8, 1), 7);
    ...
    test('next/previous shift by exactly one farm-year', () {
      ...
      expect(fy.next, FarmYear(startYear: 2026, startMonth: 7));
      expect(fy.previous, FarmYear(startYear: 2024, startMonth: 7));
    });
